...
#include "AnimGraphNode_FullbodyIKPractice.generated.h"
...
UCLASS(MinimalAPI)
class UAnimGraphNode_FullbodyIKPractice : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_FullbodyIKPractice Node;
